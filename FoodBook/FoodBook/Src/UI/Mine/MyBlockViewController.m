...
@interface MyBlockViewController ()<UITableViewDataSource,UITableViewDelegate,EGORefreshTableHeaderDelegate>
{
    int page;
}
...
-(void)refreshData{
    ...
    [self requestServiceGetWithURL:[NSString stringWithFormat:@"http://106.185.26.36:8080/yimian/app/dislike/loadDislike.do?page=%d&rows=20&token=%@",page,[UserCenter shareInstance].loginUser.token] withParam:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
