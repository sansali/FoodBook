//
//  EditFoodContentSecondViewController.m
//  FoodBook
//
...
@interface EditFoodContentSecondViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,MediaAddCollectionViewCellDelegate,ImageLoadCollectionViewCellDelegate,PreviewViewControllerDelegate>
{
...
@implementation EditFoodContentSecondViewController
...
-(void)createAll{
    ...
    editDoneBtn = [Tools createBtnWithFrame:CGRectMake(10, 250 + itemWidth, SCREENWIDTH - 20, 40) withTitle:@"编辑完成" withTitleSize:16];
    ...
    nextBtn = [Tools createBtnWithFrame:CGRectMake(10, 300 + itemWidth, SCREENWIDTH - 20, 40) withTitle:@"下一步" withTitleSize:16];
    ...
    scrollView.contentSize = CGSizeMake(SCREENWIDTH, nextBtn.frame.origin.y + 50);
...
-(void)btnClick:(UIButton *)sender{
    switch (sender.tag) {
        ...
        {
            //next
            EditFoodContentThirdViewController *vc = [[EditFoodContentThirdViewController alloc] init];
...
-(void)resizeScrollView{
    ...
    nextBtn.frame = CGRectMake(10, 50 + editDoneBtn.frame.origin.y, SCREENWIDTH - 20, 40);
